...
public class Constants {
    ...
    public final static String FILE_UPLOAD_DIC = "D:\\workwork\\NNNFT\\src\\main\\resources\\upload\\";//上传文件的默认url前缀，根据部署设置自行修改
    ...
    public final static int INDEX_GOODS_HOT_NUMBER = 6;//首页热卖商品数量
    ...
    public final static int SHOPPING_CART_ITEM_LIMIT_NUMBER = 6;//购物车中单个商品的最大购买数量(可根据自身需求修改)

    public final static int GOODS_SEARCH_PAGE_LIMIT = 10;//搜索分页的默认条数(每页10条)

    public final static int SHOPPING_CART_PAGE_LIMIT = 6;//购物车分页的默认条数(每页5条)

    public final static int ORDER_SEARCH_PAGE_LIMIT = 6;//我的订单列表分页的默认条数(每页5条)
    ...
    public final static String USER_INTRO = "这个用户很懒，什么都没有留下";//默认简介
}
